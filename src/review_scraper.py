...
# --- 設定項目 ---
# [変更] 各マスターリストのパス
RAKUTEN_MASTER_FILE = '../data/raw/hotels_raw_rakuten.csv'
JALAN_MASTER_FILE = '../data/raw/hotels_raw_jalan.csv'
# [変更] レビューデータファイルのパス
DATA_FILE = '../data/processed/hotel_review_data.json'
OUTPUT_FILE = '../data/processed/hotel_review_data.json'
